...
---|---|---|---  
`api_url` |  `str` |  Zep API URL |  _required_  
`api_key` |  `str` |  Zep API key, optional |  `None`  
...
Name | Type | Description | Default  
---|---|---|---  
`collection_name` |  `str` |  Name of the Zep collection. |  _required_  
...
`top_k` |  `Optional[int]` |  Number of results to return. Defaults to 5. |  `5`  
