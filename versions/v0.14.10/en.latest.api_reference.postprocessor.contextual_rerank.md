...
---|---|---|---  
`model` |  `str` |  str = Field(description="Contextual Reranking model name. Default is 'ctxl-rerank-en-v1-instruct'.") |  `'ctxl-rerank-en-v1-instruct'`  
`top_n` |  `int` |  int = Field(description="Top N nodes to return.") |  `2`  
