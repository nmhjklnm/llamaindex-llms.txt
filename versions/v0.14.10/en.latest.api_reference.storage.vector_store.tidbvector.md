...
---|---|---|---  
`nodes` |  `List[BaseNode]` |  List of nodes to be added. |  _required_  
`**add_kwargs` |  `Any` |  Additional keyword arguments to be passed to the underlying storage. |  `{}`  
Returns:
Type | Description  
---|---  
...
`**delete_kwargs` |  `Any` |  Additional keyword arguments to be passed to the delete method. |  `{}`  
Returns:
Type | Description  
---|---  
`None` |  None  
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `VectorStoreQuery` |  The query object containing the query data. |  _required_  
`**kwargs` |  `Any` |  Additional keyword arguments. |  `{}`  
Returns:
Name | Type | Description  
---|---|---  
`VectorStoreQueryResult` |  `VectorStoreQueryResult` |  The result of the similarity search.  
Raises:
Type | Description  
---|---  
`ValueError` |  If the query embedding is not provided.  
