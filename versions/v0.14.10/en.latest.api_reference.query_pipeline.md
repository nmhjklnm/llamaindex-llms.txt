...
Name | Type | Description | Default  
---|---|---|---  
`src` |  `str` |  Source component name |  _required_  
`dest` |  `str` |  Destination component name |  _required_  
`src_key` |  `str | None` |  Source component output key |  `None`  
`dest_key` |  `str | None` |  Destination component input key |  `None`  
`condition_fn` |  `Callable | None` |  Condition to determine if link should be followed |  `None`  
`input_fn` |  `Callable | None` |  Input to destination component |  `None`  
Source code in `llama-index-core/llama_index/core/base/query_pipeline/query.py`
