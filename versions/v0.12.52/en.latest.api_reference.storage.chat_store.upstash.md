...
---|---|---|---  
`key` |  `str` |  The key to store the messages under. |  _required_  
`messages` |  `List[ChatMessage]` |  The list of messages to store. |  _required_  
Source code in `llama-index-integrations/storage/chat_store/llama-index-storage-chat-store-upstash/llama_index/storage/chat_store/upstash/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`key` |  `str` |  The key to retrieve messages from. |  _required_  
Returns:
Type | Description  
---|---  
`List[ChatMessage]` |  List[ChatMessage]: The list of retrieved messages.  
Source code in `llama-index-integrations/storage/chat_store/llama-index-storage-chat-store-upstash/llama_index/storage/chat_store/upstash/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`key` |  `str` |  The key to add the message to. |  _required_  
`message` |  `ChatMessage` |  The message to add. |  _required_  
...
Name | Type | Description | Default  
---|---|---|---  
`key` |  `str` |  The key to delete messages from. |  _required_  
Returns:
Type | Description  
---|---  
`Optional[List[ChatMessage]]` |  Optional[List[ChatMessage]]: Always returns None in this implementation.  
Source code in `llama-index-integrations/storage/chat_store/llama-index-storage-chat-store-upstash/llama_index/storage/chat_store/upstash/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`key` |  `str` |  The key to delete the message from. |  _required_  
`idx` |  `int` |  The index of the message to delete. |  _required_  
Returns:
Type | Description  
---|---  
`Optional[ChatMessage]` |  Optional[ChatMessage]: The deleted message, or None if not found or an error occurred.  
Source code in `llama-index-integrations/storage/chat_store/llama-index-storage-chat-store-upstash/llama_index/storage/chat_store/upstash/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`key` |  `str` |  The key to delete the last message from. |  _required_  
Returns:
Type | Description  
---|---  
`Optional[ChatMessage]` |  Optional[ChatMessage]: The deleted message, or None if the list is empty.  
Source code in `llama-index-integrations/storage/chat_store/llama-index-storage-chat-store-upstash/llama_index/storage/chat_store/upstash/base.py`
