...
---|---|---|---  
`client_id` |  `str` |  The Application ID for the app registered in Microsoft Azure. |  _required_  
...
`user_email` |  `str` |  Email address of the user whose emails need to be fetched. |  _required_  
`folder` |  `Optional[str]` |  The email folder to fetch emails from. Defaults to "Inbox". |  `'Inbox'`  
`num_mails` |  `int` |  Number of emails to retrieve. Defaults to 10. |  `10`  
