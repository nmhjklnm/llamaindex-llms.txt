...
```
get_tool_calls_from_response(response: ChatResponse, error_on_no_tool_call: bool = False) -> List[ToolSelection]
...
```
get_cohere_chat_request(messages: List[ChatMessage], *, connectors: Optional[List[Dict[str, str]]] = None, stop_sequences: Optional[List[str]] = None, **kwargs: Any) -> Dict[str, Any]
...
---|---|---|---  
`messages` |  `List[ChatMessage]` |  The messages. |  _required_  
