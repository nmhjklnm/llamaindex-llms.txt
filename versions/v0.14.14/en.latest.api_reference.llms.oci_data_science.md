...
Name | Type | Description  
---|---|---  
`LLMMetadata` |  `LLMMetadata` |  The metadata of the LLM.  
###  validate_env #
```
...
---|---|---|---  
`prompt` |  `str` |  The prompt to generate a completion for. |  _required_  
`formatted` |  `bool` |  Whether the prompt is formatted. |  `False`  
`**kwargs` |  `Any` |  Additional keyword arguments. |  `{}`  
Returns:
Name | Type | Description  
---|---|---  
`CompletionResponse` |  `CompletionResponse` |  The response from the LLM.  
Source code in `llama-index-integrations/llms/llama-index-llms-oci-data-science/llama_index/llms/oci_data_science/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`messages` |  `Sequence[ChatMessage]` |  A sequence of chat messages. |  _required_  
`**kwargs` |  `Any` |  Additional keyword arguments. |  `{}`  
Returns:
Name | Type | Description  
---|---|---  
`ChatResponse` |  `ChatResponse` |  The chat response from the LLM.  
Source code in `llama-index-integrations/llms/llama-index-llms-oci-data-science/llama_index/llms/oci_data_science/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`response` |  `ChatResponse` |  The chat response containing tool calls. |  _required_  
`error_on_no_tool_call` |  `bool` |  Whether to raise an error if no tool calls are found. |  `True`  
`**kwargs` |  `Any` |  Additional keyword arguments. |  `{}`  
Returns:
Type | Description  
---|---  
`List[ToolSelection]` |  List[ToolSelection]: A list of tool selections extracted from the response.  
Raises:
Type | Description  
---|---  
`ValueError` |  If no tool calls are found and error_on_no_tool_call is True.  
