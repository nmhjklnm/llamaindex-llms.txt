...
`size` |  `int` |  Number of samples to be generated. |  _required_  
`max_token_cnt` |  `int` |  Number of tokens generated per sample. |  _required_  
`max_self_compositions` |  `int` |  PRV algorithm parameter. Defaults to 1000. |  `1000`  
...
---|---  
###  agenerate_dp_synthetic_example `async` #
```
