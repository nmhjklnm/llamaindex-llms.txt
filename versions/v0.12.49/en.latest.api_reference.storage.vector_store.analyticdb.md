...
---|---|---|---  
`region_id` |  `str` |  str |  _required_  
`instance_id` |  `str` |  str |  _required_  
`account` |  `str` |  str |  _required_  
`account_password` |  `str` |  str |  _required_  
`namespace` |  `str` |  str |  `'llama_index'`  
`namespace_password` |  `str` |  str |  `None`  
`embedding_dimension` |  `int` |  int |  `1536`  
`metrics` |  `str` |  str |  `'cosine'`  
`collection` |  `str` |  str |  `'llama_collection'`  
...
Name | Type | Description | Default  
---|---|---|---  
`ref_doc_id` |  `str` |  str: the doc_id of the document to delete. |  _required_  
Source code in `llama-index-integrations/vector_stores/llama-index-vector-stores-analyticdb/llama_index/vector_stores/analyticdb/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `VectorStoreQuery` |  VectorStoreQuery: the query to execute. |  _required_  
Returns:
Name | Type | Description  
---|---|---  
`VectorStoreQueryResult` |  `VectorStoreQueryResult` |  the result of the query.  
Source code in `llama-index-integrations/vector_stores/llama-index-vector-stores-analyticdb/llama_index/vector_stores/analyticdb/base.py`
