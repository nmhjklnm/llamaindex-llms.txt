...
---|---|---|---  
`credentials_path` |  `str` |  Rayyan credentials path. |  _required_  
`rayyan_url` |  `str` |  Rayyan URL. Defaults to https://rayyan.ai. Set to an alternative URL if you are using a non-production Rayyan instance. |  `'https://rayyan.ai'`  
...
###  load_data #
```
load_data(review_id: str, filters: dict = {}) -> List[Document]
...
Name | Type | Description | Default  
---|---|---|---  
`review_id` |  `int` |  Rayyan review ID. |  _required_  
