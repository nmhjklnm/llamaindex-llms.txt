...
`table_name` |  `str` |  Tablestore table name. |  `'llama_index_vector_store_ots_v1'`  
`index_name` |  `str` |  Tablestore SearchIndex index name. |  `'llama_index_vector_store_ots_index_v1'`  
`text_field` |  `str` |  Name of the Tablestore field that stores the text. |  `'content'`  
`vector_field` |  `str` |  Name of the Tablestore field that stores the embedding. |  `'embedding'`  
`ref_doc_id_field` |  `str` |  Name of the Tablestore field that stores the ref doc id. |  `'ref_doc_id'`  
`vector_dimension` |  `int` |  The dimension of the embedding vectors. |  `512`  
