...
---|---|---|---  
`place` |  `str` |  The place to find the weather at. Should be a city name and country. |  _required_  
Source code in `llama-index-integrations/tools/llama-index-tools-weather/llama_index/tools/weather/base.py`
...
```
forecast_tomorrow_at_location(location: str) -> List[Document]
...
Name | Type | Description | Default  
---|---|---|---  
`location` |  `str` |  The location to find the weather tomorrow at. Should be a city name and country. |  _required_  
Source code in `llama-index-integrations/tools/llama-index-tools-weather/llama_index/tools/weather/base.py`
