...
---|---|---|---  
`selector` |  `BaseSelector` |  Selector |  _required_  
...
---|---|---|---  
`selector` |  `BaseSelector` |  Selector |  _required_  
`choices` |  `List[str]` |  Choices (must correspond to components) |  _required_  
`components` |  `List[Annotated[QueryComponent, SerializeAsAny]]` |  Components (must correspond to choices) |  _required_  
