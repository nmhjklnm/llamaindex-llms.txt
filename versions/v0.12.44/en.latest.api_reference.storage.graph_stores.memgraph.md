...
---|---|---|---  
`username` |  `str` |  The username for the Memgraph database. |  _required_  
`password` |  `str` |  The password for the Memgraph database. |  _required_  
`url` |  `str` |  The URL for the Memgraph database. |  _required_  
