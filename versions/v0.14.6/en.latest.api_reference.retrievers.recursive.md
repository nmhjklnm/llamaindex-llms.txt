...
---|---|---|---  
`root_id` |  `str` |  The root id of the query graph. |  _required_  
`retriever_dict` |  `Optional[Dict[str, BaseRetriever]]` |  A dictionary of id to retrievers. |  _required_  
`query_engine_dict` |  `Optional[Dict[str, BaseQueryEngine]]` |  A dictionary of id to query engines. |  `None`  
