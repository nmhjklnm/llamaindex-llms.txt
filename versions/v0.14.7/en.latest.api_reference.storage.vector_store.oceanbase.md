...
`dim` |  `int` |  Dimension of embedding vector. |  _required_  
`table_name` |  `str` |  Which table name to use. Defaults to "llama_vector". |  `DEFAULT_OCEANBASE_VECTOR_TABLE_NAME`  
`vidx_metric_type` |  `str` |  Metric method of distance between vectors. This parameter takes values in `l2` and `inner_product`. Defaults to `l2`. |  `DEFAULT_OCEANBASE_VECTOR_METRIC_TYPE`  
...
`primary_field` |  `str` |  Name of the primary key column. Defaults to "id". |  `DEFAULT_OCEANBASE_PFIELD`  
`doc_id_field` |  `str` |  Name of the doc id column. Defaults to "doc_id". |  `DEFAULT_OCEANBASE_DOCID_FIELD`  
`vector_field` |  `str` |  Name of the vector column. Defaults to "embedding". |  `DEFAULT_OCEANBASE_VEC_FIELD`  
`text_field` |  `str` |  Name of the text column. Defaults to "document". |  `DEFAULT_OCEANBASE_DOC_FIELD`  
...
`vidx_name` |  `str` |  Name of the vector index table. |  `DEFAULT_OCEANBASE_VEC_INDEX_NAME`  
...
Type | Description  
---|---  
`List[BaseNode]` |  List[BaseNode]: List of text nodes.  
Source code in `llama-index-integrations/vector_stores/llama-index-vector-stores-oceanbase/llama_index/vector_stores/oceanbase/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `VectorStoreQuery` |  query infos |  _required_  
