...
```
astream_complete(prompt: str, formatted: bool = False, **kwargs: Any) -> CompletionResponseGen
...
###  astream_chat `async` #
```
astream_chat(messages: Sequence[ChatMessage], **kwargs: Any) -> ChatResponseGen
