...
###  add #
```
add(nodes: List[TextNode], **kwargs: Any) -> List[str]
...
---|---|---|---  
`nodes` |  `List[TextNode]` |  List[TextNode] List of text nodes |  _required_  
`kwargs` |  `Any` |  Additional arguments to pass to add |  `{}`  
Source code in `llama-index-integrations/vector_stores/llama-index-vector-stores-ApertureDB/llama_index/vector_stores/ApertureDB/base.py`
```
274
275
...
###  delete_vector_store #
```
delete_vector_store(descriptor_set_name: str) -> None
...
Name | Type | Description | Default  
---|---|---|---  
`descriptor_set_name` |  `str` |  The name of the descriptor set to delete. |  _required_  
Source code in `llama-index-integrations/vector_stores/llama-index-vector-stores-ApertureDB/llama_index/vector_stores/ApertureDB/base.py`
```
323
324
...
Name | Type | Description | Default  
---|---|---|---  
`ref_doc_id` |  `str` |  The document ID to delete. |  _required_  
`delete_kwargs` |  `Any` |  Additional arguments to pass to delete |  `{}`  
Returns:
Type | Description  
---|---  
`None` |  None  
...
###  delete_nodes #
```
delete_nodes(node_ids: Optional[List[str]] = None, filters: Optional[MetadataFilters] = None, **delete_kwargs: Any) -> List[str]
...
###  get_nodes #
```
get_nodes(node_ids: Optional[List[str]] = None, filters: Optional[MetadataFilters] = None) -> List[TextNode]
