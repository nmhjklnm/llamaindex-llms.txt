...
---|---|---|---  
`index_name` |  `str` |  The name of the index. |  _required_  
`bucket_name_or_arn` |  `str` |  The name or ARN of the vector bucket. |  _required_  
`data_type` |  `str` |  The data type of the vectors. Only supports "float32" for now. |  `'float32'`  
`insert_batch_size` |  `int` |  The batch size for inserting vectors. |  `500`  
...
Return the Qdrant client.
###  create_index_from_bucket `classmethod` #
```
create_index_from_bucket(bucket_name_or_arn: str, index_name: str, dimension: int, distance_metric: str = 'cosine', data_type: str = 'float32', insert_batch_size: int = 500, non_filterable_metadata_keys: Optional[List[str]] = None, sync_session: Optional[Session] = None, async_session: Optional[Any] = None) -> S3VectorStore
...
---|---  
###  get_name_or_arn `staticmethod` #
```
get_name_or_arn(name_or_arn: str) -> Tuple[str, str]
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `VectorStoreQuery` |  query |  _required_  
Source code in `llama-index-integrations/vector_stores/llama-index-vector-stores-s3/llama_index/vector_stores/s3/base.py`
