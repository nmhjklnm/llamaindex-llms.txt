# Query Pipeline#
Warning
Query Pipelines have recently gone into a feature-freeze/deprecation phase. If you want to orchestrate modules, we suggest checking out workflows.
## Concept#
...
![](https://docs.llamaindex.ai/en/latest/_static/query/pipeline_rag_example.png)
