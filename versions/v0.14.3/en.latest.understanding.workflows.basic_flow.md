...
![Basic workflow](https://docs.llamaindex.ai/en/latest/understanding/workflows/basic_flow.png)
...
![A simple multi-step workflow](https://docs.llamaindex.ai/en/latest/understanding/workflows/multi_step.png)
