...
---|---|---|---  
`query` |  `str` |  A natural language query phrased as an answer for what the link provides, ie: "This is the latest news about space:" |  _required_  
...
Name | Type | Description | Default  
---|---|---|---  
`url` |  `str` |  The web page to find similar results of |  _required_  
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `str` |  the natural language query |  _required_  
