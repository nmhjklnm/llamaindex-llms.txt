...
###  chat #
```
chat(messages: Sequence[ChatMessage], inference_params: Optional[Dict] = {}, **kwargs: Any) -> ChatResponse
...
###  complete #
```
complete(prompt: str, formatted: bool = False, inference_params: Optional[Dict] = {}, **kwargs: Any) -> CompletionResponse
