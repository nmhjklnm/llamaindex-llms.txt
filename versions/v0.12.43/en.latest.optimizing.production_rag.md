...
![](https://docs.llamaindex.ai/en/latest/_static/production_rag/decouple_chunks.png)
#### Motivation#
...
## Structured Retrieval for Larger Document Sets#
![](https://docs.llamaindex.ai/en/latest/_static/production_rag/structured_retrieval.png)
#### Motivation#
...
## Dynamically Retrieve Chunks Depending on your Task#
![](https://docs.llamaindex.ai/en/latest/_static/production_rag/joint_qa_summary.png)
#### Motivation#
