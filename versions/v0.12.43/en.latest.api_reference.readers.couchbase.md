...
---|---|---|---  
`client(Optional[Any])` |  |  A Couchbase client to use. If not provided, the client will be created based on the connection_string and database credentials. |  _required_  
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `str` |  The SQL++ query to execute. |  _required_  
