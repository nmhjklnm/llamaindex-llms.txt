...
---|---|---|---  
`artist_name` |  `str` |  The artist's name. |  _required_  
...
`max_pages` |  `int` |  Maximum number of pages to fetch. |  `50`  
Returns:
Name | Type | Description  
---|---|---  
`Document` |  `Document` |  A document containing lyrics of the most/least popular song.  
Source code in `llama-index-integrations/readers/llama-index-readers-genius/llama_index/readers/genius/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`lyrics` |  `str` |  The lyric snippet you're looking for. |  _required_  
Returns:
Type | Description  
---|---  
`List[Document]` |  List[Document]: A list of documents containing songs with those lyrics.  
Source code in `llama-index-integrations/readers/llama-index-readers-genius/llama_index/readers/genius/base.py`
...
Name | Type | Description | Default  
---|---|---|---  
`tag` |  `str` |  The tag or genre to load songs for. |  _required_  
`max_songs` |  `Optional[int]` |  Maximum number of songs to fetch. If None, no specific limit. |  `None`  
`max_pages` |  `int` |  Maximum number of pages to fetch. |  `50`  
Returns:
Type | Description  
---|---  
`List[Document]` |  List[Document]: A list of documents containing song lyrics.  
Source code in `llama-index-integrations/readers/llama-index-readers-genius/llama_index/readers/genius/base.py`
