...
---|---|---|---  
`top_n` |  `int` |  Top N nodes to return. |  _required_  
`choice_select_prompt` |  `BasePromptTemplate` |  Choice select prompt. |  _required_  
`choice_batch_size` |  `int` |  Batch size for choice select. |  _required_  
`llm` |  `LLM` |  The LLM to rerank with. |  _required_  
