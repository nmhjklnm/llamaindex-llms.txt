...
Bases: `CouchbaseSearchVectorStore`
...
`**kwargs` |  `Any` |  Additional keyword arguments. batch_size (int): Size of the batch for batch insert. |  `{}`  
Returns:
Type | Description  
---|---  
...
Name | Type | Description | Default  
---|---|---|---  
`ref_doc_id` |  `str` |  The reference document ID to be deleted. |  _required_  
Returns:
Type | Description  
---|---  
`None` |  None  
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `VectorStoreQuery` |  The query object containing the search parameters. |  _required_  
`**kwargs` |  `Any` |  Additional keyword arguments. cb_search_options (Dict): Search options to pass to Couchbase Search |  `{}`  
Returns:
Name | Type | Description  
---|---|---  
`VectorStoreQueryResult` |  `VectorStoreQueryResult` |  The result of the query containing the top-k nodes, similarities, and ids.  
Source code in `llama-index-integrations/vector_stores/llama-index-vector-stores-couchbase/llama_index/vector_stores/couchbase/base.py`
