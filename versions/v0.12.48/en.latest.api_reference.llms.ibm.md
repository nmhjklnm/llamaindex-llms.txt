...
---|---  
###  sample_generation_text_params `property` #
```
sample_generation_text_params: Dict[str, Any]

```

Example of Model generation text kwargs that a user can pass to the model.
###  sample_chat_generation_params `property` #
```
sample_chat_generation_params: Dict[str, Any]
