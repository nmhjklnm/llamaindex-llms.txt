...
---|---|---|---  
`summary_template` |  `Optional[BasePromptTemplate]` |  A Summarization Prompt (see :ref:`Prompt-Templates`). |  `None`  
`insert_prompt` |  `Optional[BasePromptTemplate]` |  An Tree Insertion Prompt (see :ref:`Prompt-Templates`). |  `None`  
`num_children` |  `int` |  The number of children each node should have. |  `10`  
