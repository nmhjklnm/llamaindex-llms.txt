...
---|---|---|---  
`embedding_dimensions` |  `int` |  Number of elements in the embedding to be stored |  _required_  
`distance_type` |  `VectorDistanceType` |  Distance metric to be used for vector search |  `EUCLIDEAN`  
`db_directory` |  `str` |  File path where ObjectBox database files will be stored |  `None`  
