...
---|---|---|---  
`llama_pack_class` |  `str` |  The name of the LlamaPack class you want to download, such as `GmailOpenAIAgentPack`. |  _required_  
...
Type | Description  
---|---  
`Optional[Type[BaseLlamaPack]]` |  A Loader.  
