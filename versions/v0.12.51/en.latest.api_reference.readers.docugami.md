...
```
file_paths: Optional[Sequence[Union[Path, str]]] = file_paths
...
```
include_project_metadata_in_doc_metadata: bool = include_project_metadata_in_doc_metadata
...
###  load_data #
```
load_data(docset_id: str, document_ids: Optional[List[str]] = None, access_token: Optional[str] = None) -> List[Document]
...
---|---|---|---  
`docset_id` |  `str` |  Document set ID to load data for. |  _required_  
