...
---|---|---|---  
`username` |  `str` |  The username for the Neo4j database. |  _required_  
`password` |  `str` |  The password for the Neo4j database. |  _required_  
`url` |  `str` |  The URL for the Neo4j database. |  _required_  
