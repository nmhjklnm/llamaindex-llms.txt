...
---|---|---|---  
`model_id` |  `str` |  The model_id of the model deployed in the Elasticsearch cluster. |  _required_  
`input_field` |  `str` |  The name of the key for the input text field in the document. Defaults to 'text_field'. |  `'text_field'`  
