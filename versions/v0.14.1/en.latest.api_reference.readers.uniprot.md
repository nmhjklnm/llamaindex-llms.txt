...
###  lazy_load_data #
```
lazy_load_data(input_file: str, extra_info: Optional[Dict] = {}) -> Generator[Document, None, None]
...
Name | Type | Description | Default  
---|---|---|---  
`input_file` |  `str` |  Path to the UniProt file |  _required_  
`extra_info` |  `Optional[Dict]` |  Additional metadata to add to each document |  `{}`  
Yields:
Name | Type | Description  
---|---|---  
`Document` |  `Document` |  One document at a time  
Source code in `llama-index-integrations/readers/llama-index-readers-uniprot/llama_index/readers/uniprot/base.py`
...
###  count_records #
```
count_records(file_path: str) -> int
...
Name | Type | Description | Default  
---|---|---|---  
`file_path` |  `str` |  Path to the UniProt database file |  _required_  
Returns:
Name | Type | Description  
---|---|---  
`int` |  `int` |  Total number of protein records in the file  
Source code in `llama-index-integrations/readers/llama-index-readers-uniprot/llama_index/readers/uniprot/base.py`
