...
![A concurrent workflow](https://docs.llamaindex.ai/en/latest/understanding/workflows/different_events.png)
## Verbose mode#
...
![Arize flow](https://docs.llamaindex.ai/en/latest/understanding/workflows/arize.png)
## One more thing#
