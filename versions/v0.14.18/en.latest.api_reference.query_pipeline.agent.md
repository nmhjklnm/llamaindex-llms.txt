...
---|---|---|---  
`fn` |  `Callable` |  Function to run. |  _required_  
`async_fn` |  `Callable | None` |  Async function to run. If not provided, will run `fn`. |  `None`  
Source code in `llama-index-core/llama_index/core/query_pipeline/components/agent.py`
...
---|---|---|---  
`fn` |  `Callable` |  Function to run. |  _required_  
`async_fn` |  `Annotated[Callable, WithJsonSchema, WithJsonSchema] | None` |  Async function to run. If not provided, will run `fn`. |  `None`  
Source code in `llama-index-core/llama_index/core/query_pipeline/components/agent.py`
