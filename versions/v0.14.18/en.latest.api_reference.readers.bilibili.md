...
###  load_data #
```
load_data(video_urls: List[str], **load_kwargs: Any) -> List[Document]
...
Type | Description  
---|---  
`List[Document]` |  List[Document]: A list of Document objects, each containing the transcript for a Bilibili video.  
Source code in `llama-index-integrations/readers/llama-index-readers-bilibili/llama_index/readers/bilibili/base.py`
