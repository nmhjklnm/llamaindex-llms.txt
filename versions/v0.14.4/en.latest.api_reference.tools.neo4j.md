...
---|---|---|---  
`neo4j_query` |  `str` |  The Cypher query to be executed. |  _required_  
...
Name | Type | Description | Default  
---|---|---|---  
`question` |  `str` |  The question to construct the Cypher query for. |  _required_  
...
Name | Type | Description | Default  
---|---|---|---  
`question` |  `str` |  The question to execute the Cypher query for. |  _required_  
`history` |  `list` |  A list of previous interactions for context. Defaults to None. |  `None`  
