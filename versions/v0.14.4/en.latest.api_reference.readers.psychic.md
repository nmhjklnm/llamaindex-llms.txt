...
---|---|---|---  
`psychic_key` |  `str` |  Secret key for Psychic. Get one at https://dashboard.psychic.dev/api-keys. |  `None`  
...
Name | Type | Description | Default  
---|---|---|---  
`connector_id` |  `str` |  The connector ID to connect to |  `None`  
`account_id` |  `str` |  The account ID to connect to |  `None`  
Returns:
Type | Description  
---|---  
