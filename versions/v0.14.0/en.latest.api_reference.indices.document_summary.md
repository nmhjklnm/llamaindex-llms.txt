...
---|---|---|---  
`response_synthesizer` |  `BaseSynthesizer` |  A response synthesizer for generating summaries. |  `None`  
`summary_query` |  `str` |  The query to use to generate the summary for each document. |  `DEFAULT_SUMMARY_QUERY`  
...
Name | Type | Description | Default  
---|---|---|---  
`doc_id` |  `str` |  A document id. |  _required_  
Source code in `llama-index-core/llama_index/core/indices/document_summary/base.py`
