...
---|---|---|---  
`keyword_extract_template` |  `Optional[BasePromptTemplate]` |  A Keyword Extraction Prompt (see :ref:`Prompt-Templates`). |  `None`  
`query_keyword_extract_template` |  `Optional[BasePromptTemplate]` |  A Query Keyword Extraction Prompt (see :ref:`Prompt-Templates`). |  `None`  
