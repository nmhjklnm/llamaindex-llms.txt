...
###  scrape_as_markdown #
```
scrape_as_markdown(url: str, zone: Optional[str] = None) -> Document
...
---|---|---  
`Document` |  `Document` |  Scraped content as Markdown  
Source code in `llama-index-integrations/tools/llama-index-tools-brightdata/llama_index/tools/brightdata/base.py`
...
###  get_screenshot #
```
get_screenshot(url: str, output_path: str, zone: Optional[str] = None) -> str
...
Name | Type | Description | Default  
---|---|---|---  
`url` |  `str` |  URL to screenshot |  _required_  
`output_path` |  `str` |  Path to save the screenshot |  _required_  
`zone` |  `Optional[str]` |  Override default zone |  `None`  
Returns:
Name | Type | Description  
---|---|---  
`str` |  `str` |  Path to saved screenshot  
Source code in `llama-index-integrations/tools/llama-index-tools-brightdata/llama_index/tools/brightdata/base.py`
...
###  search_engine #
```
search_engine(query: str, engine: str = 'google', zone: Optional[str] = None, language: Optional[str] = None, country_code: Optional[str] = None, search_type: Optional[str] = None, start: Optional[int] = None, num_results: Optional[int] = 10, location: Optional[str] = None, device: Optional[str] = None, return_json: bool = False, hotel_dates: Optional[str] = None, hotel_occupancy: Optional[int] = None) -> Document
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `str` |  Search query |  _required_  
`engine` |  `str` |  Search engine - 'google', 'bing', or 'yandex' |  `'google'`  
`zone` |  `Optional[str]` |  Override default zone |  `None`  
...
`num_results` |  `Optional[int]` |  Number of results to return (default 10) |  `10`  
...
Name | Type | Description  
---|---|---  
`Document` |  `Document` |  Search results as Markdown or JSON  
Source code in `llama-index-integrations/tools/llama-index-tools-brightdata/llama_index/tools/brightdata/base.py`
...
###  web_data_feed #
```
web_data_feed(source_type: str, url: str, num_of_reviews: Optional[int] = None, timeout: int = 600, polling_interval: int = 1) -> Dict
...
Name | Type | Description | Default  
---|---|---|---  
`source_type` |  `str` |  Type of data source (e.g., 'linkedin_person_profile', 'amazon_product') |  _required_  
`url` |  `str` |  URL of the web resource to retrieve data from |  _required_  
`num_of_reviews` |  `Optional[int]` |  Number of reviews to retrieve (only for facebook_company_reviews) |  `None`  
`timeout` |  `int` |  Maximum time in seconds to wait for data retrieval |  `600`  
`polling_interval` |  `int` |  Time in seconds between polling attempts |  `1`  
Returns:
Name | Type | Description  
---|---|---  
