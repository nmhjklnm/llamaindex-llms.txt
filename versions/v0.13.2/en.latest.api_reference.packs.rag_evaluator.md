...
---|---|---|---  
`query_engine` |  `BaseQueryEngine` |  The RAG pipeline to evaluate. |  _required_  
`rag_dataset` |  `BaseLlamaDataset` |  The BaseLlamaDataset to evaluate on. |  _required_  
`judge_llm` |  `Optional[LLM]` |  The LLM to use as the evaluator. |  `None`  
