...
Name | Type | Description | Default  
---|---|---|---  
`persist_dir` |  `str` |  directory to persist the store |  `DEFAULT_PERSIST_DIR`  
`namespace` |  `Optional[str]` |  namespace for the docstore |  `None`  
`fs` |  `Optional[AbstractFileSystem]` |  filesystem to use |  `None`  
Source code in `llama-index-core/llama_index/core/storage/docstore/simple_docstore.py`
...
Name | Type | Description | Default  
---|---|---|---  
`persist_path` |  `str` |  Path to persist the store |  _required_  
`namespace` |  `Optional[str]` |  namespace for the docstore |  `None`  
