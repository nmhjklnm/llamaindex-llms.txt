...
Name | Type | Description | Default  
---|---|---|---  
`workspace` |  `str` |  the handle for a Steamship workspace (see: https://docs.steamship.com/workspaces/index.html) |  _required_  
...
`join_str` |  `str` |  when collapse_blocks is True, this is how the block texts will be concatenated. |  `'\n\n'`  
Note
