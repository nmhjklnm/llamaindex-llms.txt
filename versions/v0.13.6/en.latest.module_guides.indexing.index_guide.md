...
![](https://docs.llamaindex.ai/en/latest/_static/indices/list.png)
### Querying#
...
![](https://docs.llamaindex.ai/en/latest/_static/indices/list_query.png)
...
![](https://docs.llamaindex.ai/en/latest/_static/indices/list_filter_query.png)
## Vector Store Index#
The vector store index stores each Node and a corresponding embedding in a Vector Store.
![](https://docs.llamaindex.ai/en/latest/_static/indices/vector_store.png)
### Querying#
...
![](https://docs.llamaindex.ai/en/latest/_static/indices/vector_store_query.png)
## Tree Index#
The tree index builds a hierarchical tree from a set of Nodes (which become leaf nodes in this tree).
![](https://docs.llamaindex.ai/en/latest/_static/indices/tree.png)
### Querying#
...
![](https://docs.llamaindex.ai/en/latest/_static/indices/tree_query.png)
## Keyword Table Index#
...
![](https://docs.llamaindex.ai/en/latest/_static/indices/keyword.png)
### Querying#
...
![](https://docs.llamaindex.ai/en/latest/_static/indices/keyword_query.png)
