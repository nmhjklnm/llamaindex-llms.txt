...
---|---|---|---  
`issue_key` |  `str` |  The Jira issue key for which to retrieve comments. |  _required_  
...
Name | Type | Description | Default  
---|---|---|---  
`issue_key` |  `str` |  The unique key or ticket number of the Jira issue. |  _required_  
...
Name | Type | Description | Default  
---|---|---|---  
`keyword` |  `str` |  The keyword to search for within issue summaries, descriptions, or comments. |  _required_  
`max_results` |  `int` |  The maximum number of issues to return. Defaults to 10. If set higher than 100, it will be limited to 100. |  `10`  
Returns:
Name | Type | Description  
---|---|---  
