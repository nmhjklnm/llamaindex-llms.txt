...
---|---|---  
`Any` |  `Any` |  DeepLake vectorstore dataset.  
###  get_nodes #
```
...
Name | Type | Description | Default  
---|---|---|---  
`query` |  `VectorStoreQuery` |  VectorStoreQuery class input, it has the following attributes: 1. query_embedding (List[float]): query embedding 2. similarity_top_k (int): top k most similar nodes |  _required_  
