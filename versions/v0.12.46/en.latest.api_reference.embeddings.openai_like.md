...
---|---|---|---  
`model_name` |  `str` |  Model for embedding. |  _required_  
`api_key` |  `str` |  The API key (if any) to use for the embedding API. |  `'fake'`  
`api_base` |  `str` |  The base URL for the embedding API. |  `None`  
`api_version` |  `str` |  The version for the embedding API. |  `None`  
`max_retries` |  `int` |  The maximum number of retries for the embedding API. |  `10`  
...
`callback_manager` |  `CallbackManager` |  The callback manager for the embedding API. |  `None`  
...
`dimensions` |  `int` |  The number of dimensions for the embedding API. |  `None`  
Example
```
