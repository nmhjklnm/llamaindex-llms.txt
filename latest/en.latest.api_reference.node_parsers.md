...
`callback_manager` |  `CallbackManager` |  |  `<llama_index.core.callbacks.base.CallbackManager object at 0x78f8fc6071a0>`  
...
Name | Type | Description | Default  
---|---|---|---  
`documents` |  `Sequence[Document]` |  documents to parse |  _required_  
