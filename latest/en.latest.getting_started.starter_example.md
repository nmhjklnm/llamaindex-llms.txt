...
Tip
If you are using an OpenAI-Compatible API, you can use the `OpenAILike` LLM class. You can find more information in the OpenAILike LLM integration and OpenAILike Embeddings integration.
## Basic Agent Example#
