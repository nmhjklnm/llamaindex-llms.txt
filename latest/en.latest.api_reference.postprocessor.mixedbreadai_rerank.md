...
---|---|---|---  
`top_n` |  `int` |  Top N nodes to return. Defaults to 10. |  `10`  
`model` |  `str` |  mixedbread ai model name. Defaults to "mixedbread-ai/mxbai-rerank-large-v1". |  `'mixedbread-ai/mxbai-rerank-large-v1'`  
