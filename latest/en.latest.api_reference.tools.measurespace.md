...
###  get_hourly_weather_forecast #
```
get_hourly_weather_forecast(location: str) -> List[Document]
...
---|---|---|---  
`location` |  `str` |  location name |  _required_  
Source code in `llama-index-integrations/tools/llama-index-tools-measurespace/llama_index/tools/measurespace/base.py`
...
###  get_daily_weather_forecast #
```
get_daily_weather_forecast(location: str) -> List[Document]
...
###  get_daily_climate_forecast #
```
get_daily_climate_forecast(location: str) -> List[Document]
...
###  get_daily_air_quality_forecast #
```
get_daily_air_quality_forecast(location: str) -> List[Document]
...
###  get_latitude_longitude_from_location #
```
get_latitude_longitude_from_location(location: str) -> List[Document]
...
###  get_location_from_latitude_longitude #
```
get_location_from_latitude_longitude(latitude: float, longitude: float) -> List[Document]
